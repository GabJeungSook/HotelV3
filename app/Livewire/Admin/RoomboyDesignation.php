...
class RoomboyDesignation extends Component implements Tables\Contracts\HasTable, \Filament\Forms\Contracts\HasForms
{
            ...
            Action::make('Manage Designation')
                ...
                ->action(function ($record, $data) {
                    ...
                    $this->dialog()->success(
                        ...
                        $description = 'The roomboy designation has been updated successfully.'
                    );
                })
