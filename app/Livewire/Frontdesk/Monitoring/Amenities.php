...
class Amenities extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->amenities_list = RequestableItem::where(
            'branch_id',
            auth()->user()->branch_id
        )->get();
    ...
    public function saveTransaction()
    {
        ...
        $this->dialog()->success(
            $title = 'Success',
            $description = 'Amenity successfully saved'
        );
    ...
    {
        return view('livewire.frontdesk.monitoring.amenities');
    }
}
