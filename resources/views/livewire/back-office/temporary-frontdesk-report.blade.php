<div class="max-w-7xl mx-auto px-4 py-8 space-y-6 bg-gray-100 min-h-screen text-gray-900">
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1 font-bold" colspan="2">₱ 36,590.00</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1 align-top font-bold">₱ 36,590.00</td>
                            <td class="border border-black px-2 py-1 align-top">-</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 align-top">
                        ...
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Total Cash Received</td>
                            <div>(Beginning Cash)</div>
                            <td class="border border-black px-2 py-1 font-bold">₱  45,716.00 <span class="text-red-600">(-275)</span></td>
                            <td class="border border-black px-2 py-1">-</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px] mb-8">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Extension</td>
                            <td class="border border-black px-2 py-1">-</td>
                            <td class="border border-black px-2 py-1">₱3,136.00</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Food</td>
                            <td class="border border-black px-2 py-1"></td>
                            <td class="border border-black px-2 py-1">₱ 100.00</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Drink</td>
                            <td class="border border-black px-2 py-1">-</td>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1 align-top font-bold">₱ 2,600</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Total Check-out</td>
                            <td class="border border-black px-2 py-1">107</td>
            ...
            <div>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Gross Sales</td>
                            <td class="border border-black px-2 py-1">₱ 52,958.00</td>
                            <td class="border border-black px-2 py-1"></td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Expenses</td>
                        ...
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1">₱ 2,600.00</td>
                            <td class="border border-black px-2 py-1"></td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Net Sales</td>
                            <td class="border border-black px-2 py-1 font-bold">₱ 40,951.00</td>
                            <td class="border border-black px-2 py-1"></td>
                        </tr>
                    </tbody>
                </table>
    ...
    @else
        ...
        <div id="daily-shift-summary" class="mx-auto max-w-[900px] text-[14px] leading-tight text-black space-y-8">
            ...
            <div class="space-y-1 text-[13px]">
                <p>Frontdesk (Outgoing): Kathleen Drew and Hanah </p>
                <p>Frontdesk (Incoming): Jeneath Lecias and Ruby Gold</p>
                <p>Shift Opened: March 09, 2026 08:33 PM </p>
                <p>Shift Closed: March 10, 2026 08:37 AM</p>
            </div>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1 align-top font-bold">₱ 40,951.00</td>
                            <td class="border border-black px-2 py-1 align-top">-</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 align-top">
                            ...
                            <td class="border border-black px-2 py-1 align-top">₱ 2,600.00</td>
                            <td class="border border-black px-2 py-1 align-top">-</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 align-top">
                        ...
                        <tr>
                            <td class="border border-black px-2 py-1 align-top">
                                <div class="font-bold">Cash Forwarded</div>
                                <div>(Previous Shift)</div>
                            </td>
                            <td class="border border-black px-2 py-1 align-top">45,716.00</td>
                            <td class="border border-black px-2 py-1 align-top">-</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Total Cash Received</td>
                            <div>(Beginning Cash)</div>
                            <td class="border border-black px-2 py-1 font-bold">₱  86,594.00 <span class="text-red-600">(-2,673.00)</span></td>
                            <td class="border border-black px-2 py-1">-</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px] mb-8">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1 align-top">78</td>
                            <td class="border border-black px-2 py-1 align-top font-bold">₱29,736.00</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Extension</td>
                            <td class="border border-black px-2 py-1">-</td>
                            <td class="border border-black px-2 py-1">₱224.00</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Transfer Room</td>
                            <td class="border border-black px-2 py-1">-</td>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border border-black px-2 py-1 align-top">40</td>
                            <td class="border border-black px-2 py-1 align-top font-bold">₱ 8,000.00</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Total Check-out</td>
                            <td class="border border-black px-2 py-1">38</td>
            ...
            <div>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Expected Cash</td>
                            <td class="border border-black px-2 py-1" colspan="2">₱ 127,227.00</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Actual Cash</td>
                            <td class="border border-black px-2 py-1" colspan="2">₱ 52,998.00</td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold text-red-600">Difference</td>
                            <td class="border border-black px-2 py-1 text-red-600 font-bold" colspan="2">₱ 74,229.00</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div>
                ...
                <table class="w-full border-collapse table-fixed border border-black text-[13px]">
                    ...
                    <tbody>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Gross Sales</td>
                            <td class="border border-black px-2 py-1">₱ 29,960.00</td>
                            <td class="border border-black px-2 py-1"></td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Expenses</td>
                        ...
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Key/Remote Deposit</td>
                            <td class="border border-black px-2 py-1">₱ 8,000.00</td>
                            <td class="border border-black px-2 py-1"></td>
                        </tr>
                        <tr>
                            <td class="border border-black px-2 py-1 font-bold">Net Sales</td>
                            <td class="border border-black px-2 py-1 font-bold">₱  21,960.00</td>
                            <td class="border border-black px-2 py-1"></td>
                        </tr>
                    </tbody>
                </table>
