<div>
    ...
    <div class="flex mb-5 space-x-3">
      <x-button wire:click="redirectBack" icon="arrow-left" red label="Back" />
      <x-button wire:click="$set('add_modal', true)" icon="plus" blue label="Add Cash Drawer" />
    </div>
    {{ $this->table }}
  </div>
  ...
  <x-modal wire:model="add_modal" align="center" max-width="lg">
    <x-card>
      <div class="header flex space-x-2 items-center">
        ...
        <h1 class="text-lg font-semibold uppercase text-gray-600 ">Add New Cash Drawer</h1>
      </div>
