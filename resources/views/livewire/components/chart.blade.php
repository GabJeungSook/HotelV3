<div>
    {{-- <div class="mt-10 flex justify-start mr-6">
        <div>
            <div class="flex space-x-3">
                <x-datetime-picker label="Date From" without-time placeholder="Date From" wire:model="date_from"/>
                <x-datetime-picker label="Date To" without-time placeholder="Date To" wire:model="date_to"/>
                <div class="mt-6">
    ...
    <div class="mt-2 w-full p-4 border border-gray-200 rounded-md shadow-lg" >
        <div class="flex justify-between items-center mb-4">
            ...
            <div>
                <select id="chartFilter" wire:model.live="chartFilter" class="w-36 border border-[#009ff4] rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[#009ff4] focus:border-[#009ff4] text-[#009ff4] bg-white font-semibold shadow-sm transition">
    ...
    document.addEventListener('livewire:initialized', function () {
        ...
        // Livewire 3 event listener - params come as a single array
