<div class="p-6">
    ...
    <div class="grid grid-cols-4 md:grid-cols-4 gap-6">
        ...
        <div class="border rounded-md col-span-3 bg-gray-50 p-4 shadow-sm text-sm text-gray-700">
            <h3 class="text-lg font-semibold text-gray-700 mb-4">Amenities</h3>
            <div class="w-full text-lg mb-2">

                <x-native-select label="Select Amenity" wire:model="item_id">
                    <option selected hidden>Select One</option>
                    @forelse ($amenities_list as $amenity)
                      <option value="{{ $amenity->id }}">{{ $amenity->name }}</option>
                    @empty
                      <option>No Amenities Available</option>
                    @endforelse
                </x-native-select>
                ...
                <div class="mt-4">
                    <x-input label="Quantity" wire:model="item_quantity" type="number" placeholder="1" class="text-right px-2 py-2" min="1" />
                </div>
