<div class="p-6">
    ...
    <div class="grid grid-cols-4 md:grid-cols-4 gap-6">
        ...
        {{-- Right: Food & Beverages --}}
        <div class="border rounded-md col-span-3 bg-gray-50 p-4 shadow-sm text-sm text-gray-700">
            <h3 class="text-lg font-semibold text-gray-700 mb-4">Food & Beverages</h3>
            ...
            <div class="w-full text-lg mb-2 space-y-4">
                ...
                <div>
                    <label class="block font-medium mb-1 text-gray-600">Price per Item</label>
                    <div class="p-2 bg-gray-100 rounded-md text-gray-800 font-medium">
                        ₱ {{ number_format($food_price, 2) }}
                    </div>
                </div>

                <x-input label="Quantity" wire:model.live="food_quantity" type="number" min="1" placeholder="1" />
